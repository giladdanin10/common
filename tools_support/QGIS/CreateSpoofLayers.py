def CreateSpoofLayers(layer_name="spoof",spoof_cases_df_csv_file=None,spoof_clusters_gdf_csv_file = None, output_shapefile=None, highlight_clusters=None, iteration_num=None, exclude_clusters=None,file_name_prefix=""):
    """
