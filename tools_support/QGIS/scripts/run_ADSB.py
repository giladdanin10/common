...
import os
# algo
run_dir_base = r'C:\work\code\TipAndQue-algo\src\test\spoofing\run_results\\'
run_name = 'aircraft_data_20240401_algo_dr_based'   
in_dir = run_dir_base +run_name+'\\'+ "QGIS_in" + "\\"
...
CreateSpoofLayers(run_name,events_data_file,highlight_clusters=-1)
